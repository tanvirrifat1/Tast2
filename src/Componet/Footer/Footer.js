...
const Footer = () => {
    return (
        <div>
            <div>
                <footer className="footer p-10 dark:bg-gray-800 dark:text-gray-50 mt-20 rounded-2xl">
                    <div>
                        <h1 className='text-3xl'>SuperBio</h1>
                        <p>Supercharge your <br />
                            Link in Bio</p>
                    </div>
                    <div>
                        <h1 className='text-3xl'>Get Started</h1>
                        <a className="link link-hover">Sign Up for Free</a>
            ...
            <div>
                <footer className="footer items-center p-8 -my-10 dark:bg-gray-900 dark:text-gray-50 rounded-3xl -mt-3 text-neutral-content">
                    ...
                    <div className="items-center grid-flow-col">
                        <h1 className='text-xl'>Email : hello@superbio.me</h1>
                    </div>
                    <div className="items-center grid-flow-col">
